...
general purpose request methods such as `link:../../apidocs/io/vertx/core/http/HttpClient.html#request-io.vertx.core.http.HttpMethod-io.vertx.core.net.ConnectOptions-java.lang.String-io.vertx.core.Handler-[request]` which allow you to specify
...
one of the general purpose request methods such as `link:../../apidocs/io/vertx/core/http/HttpClient.html#request-io.vertx.core.http.HttpMethod-io.vertx.core.net.ConnectOptions-java.lang.String-io.vertx.core.Handler-[request]`.
